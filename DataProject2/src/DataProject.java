...
class DataProject
{
   ArrayList<String> courseNumbers;
    ...
    ArrayList<String> studentPrimaryKey;
   ...
   void initalizeValues()
   {
       ...
       studentPrimaryKey = new ArrayList<String>();
      ...
      //initalizes courses ALL user inputed courses should be checked as valid via the testCourseInputMethod
       try
       {
           ...
           //populate student request unique keys
           Statement myotherStatment3=myConnection.createStatement();
           ResultSet studentRequestResult=myotherStatment3.executeQuery("select id, course_number, request_date, semester, request_year from student_request");
		   String s_id;
		   String s_course_number;
		   String s_semester;
		   String s_request_year;
           isNotEmpty=false;
           empty=true;
           while (isNotEmpty=studentRequestResult.next())
           {
               //System.out.println("Got a user");
               s_id=studentRequestResult.getString(1);
               s_course_number=studentRequestResult.getString(2);
               s_semester=studentRequestResult.getString(4);
               s_request_year=studentRequestResult.getString(5);
               
			   //System.out.println(id+" "+course_number+" "+semester+" "+ request_year);
			   studentPrimaryKey.add(s_id+" "+s_course_number+s_semester+" "+ s_request_year);
